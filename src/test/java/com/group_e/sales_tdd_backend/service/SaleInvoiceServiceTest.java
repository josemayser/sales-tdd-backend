...
public class SaleInvoiceServiceTest {
    ...
    @Test
    void shouldCalculateDiscountCorrectly_whenCustomerAndProductHaveDiscounts() throws CustomerNotFoundException,
            WarehouseNotFoundException, PaymentConditionNotFoundException, ProductNotFoundException {
